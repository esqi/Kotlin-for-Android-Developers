...
import net.esqiaktiadi.weatherapp.ui.adapters.ForecastCardAdapter
import org.jetbrains.anko.startActivity

/**
 * Provides UI for the view with Cards.
 */
class CardContentFragment : Fragment(), ForecastListDataFragment {
    ...
    private fun setAdapter(v : View? = view){
        if(v != null){
            forecastList?.let {
                ...
                val adapter = ForecastCardAdapter(result) {
